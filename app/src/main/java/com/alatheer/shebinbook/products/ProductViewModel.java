...
public class ProductViewModel {
    ...
    public void getAdvertisment(String trader_id) {
        ...
        if (Utilities.isNetworkAvailable(context)){
            ...
            Call<SliderModel> call = getDataService.get_ads_in_store(user_gender+"",5,trader_id,page2);
                        ...
                        if (response.body().getStatus()){
                            ...
                            if (!sliderList.isEmpty()){
                                if (page2 <= 4){
                                    ...
                                    productsActivity.init_sliders(sliderAdapter);
                                    page2 = page2+1;
                                    performpagination(trader_id,page2);
                                }
                            }else {
                                productsActivity.setViewpagervisibility();
                            }
                        }
                    }
                }
        ...
        if (Utilities.isNetworkAvailable(context)){
            ...
            call.enqueue(new Callback<ProfileData>() {
                ...
                public void onResponse(Call<ProfileData> call, Response<ProfileData> response) {
                    if (response.isSuccessful()){
                        if (response.body().getStatus()){
                            productsActivity.setData(response.body());
